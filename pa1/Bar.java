...
public class Bar {
   ...
   */
   public void draw(Graphics2D g2) {
       ...
       Rectangle bar = new Rectangle(barX, stringY - 15 - barHeight, barWidth, barHeight);
       g2.fill(bar);

       Font font = g2.getFont();
       FontRenderContext context = g2.getFontRenderContext();
       Rectangle2D bounds = font.getStringBounds(barLabel, context);
       double labelWidth = bounds.getWidth();
       stringX = (int)(barX + (double)barWidth / 2 - labelWidth / 2);

       g2.setColor(Color.black);
       g2.drawString(barLabel, stringX, stringY);
   }
}
